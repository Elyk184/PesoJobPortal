    ...
    <div class="col-lg-8">
        ...
        <div class="info-card">
            ...
            <div style="margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid var(--as-border);">
                ...
                <p class="mb-0" style="font-size: 0.95rem; line-height: 1.6; color: #334155;">{{ $application->notes }}</p>
            </div>
            @endif
        </div>
        ...
        <div class="info-card">
            ...
            <form id="feedbackForm" action="{{ route('employer.applications.feedback', $application->id) }}" method="POST">
                ...
                <div class="d-flex gap-2">
                    ...
                    @if($application->resume_path)
                        <a href="{{ route('employer.applications.resume.view', $application->id) }}" class="btn btn-outline-primary" target="_blank" rel="noopener">View Resume</a>
                    @endif
                </div>
            </form>
        </div>
