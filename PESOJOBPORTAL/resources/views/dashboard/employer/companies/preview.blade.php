...
@section('title', 'Company Preview - PESO')
...
<div class="company-preview-wrap">
    <div class="preview-card">
        <div class="preview-hero">
            ...
            <div>
                <h1 class="preview-title">{{ $companyName }}</h1>
                <div class="preview-sub">
                    ...
                    @if($companyProfile?->establishment_email)
                        <span class="chip"><i class="bi bi-envelope"></i> {{ $companyProfile->establishment_email }}</span>
                    @endif
                </div>
            </div>
        </div>
        ...
        <div class="preview-body">
            <div class="section">
                <h5><i class="bi bi-info-circle"></i> Company Overview</h5>
                    ...
                    {{ $companyInformationPreview ?? 'No company information provided yet.' }}
                </div>
            ...
            <div class="section">
                ...
                <div class="kv">
                    ...
                    <div class="item">
                        ...
                        <div class="v">{{ $companyProfile?->contact_person_name ?? $companyProfile?->establishment_contact_person ?? '—' }}</div>
                    </div>
                    <div class="item">
                        <div class="k">Contact Position</div>
                        <div class="v">{{ $companyProfile?->establishment_contact_position ?? '—' }}</div>
                    </div>
                    <div class="item">
                        <div class="k">Mobile Number</div>
                        <div class="v">{{ $companyProfile?->contact_person_phone ?? $companyProfile?->establishment_phone ?? '—' }}</div>
                    </div>
                </div>
            </div>
        </div>
