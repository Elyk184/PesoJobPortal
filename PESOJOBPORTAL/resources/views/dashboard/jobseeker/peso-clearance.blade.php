									...
									<div class="clearance-request-body">
										...
										<form method="POST" action="{{ route('jobseeker.peso-clearance.request') }}" enctype="multipart/form-data">
											...
											<div class="clearance-upload-card mb-3">
												...
												<input id="pesoClearanceReceiptRenewal" type="file" name="peso_clearance_assurance_receipt" class="form-control @error('peso_clearance_assurance_receipt') is-invalid @enderror" accept=".pdf,.jpg,.jpeg,.png" required>
											...
											<div class="clearance-upload-card mb-3">
												...
												<input id="barangayClearanceRenewal" type="file" name="barangay_clearance" class="form-control @error('barangay_clearance') is-invalid @enderror" accept=".pdf,.jpg,.jpeg,.png" required>
											...
											<div class="clearance-check mb-3 form-check">
												<input type="checkbox" name="is_first_time_jobseeker" class="form-check-input" id="isFirstTimeJobseekerRenewal" value="1" @checked(old('is_first_time_jobseeker'))>
											...
											<div class="clearance-upload-card mb-3" id="firstTimeDocumentDivRenewal" style="display: {{ old('is_first_time_jobseeker') ? 'block' : 'none' }};">
												...
												<input type="file" name="first_time_jobseeker_document" id="firstTimeJobseekerDocumentRenewal" class="form-control @error('first_time_jobseeker_document') is-invalid @enderror" accept=".pdf,.jpg,.jpeg,.png" {{ old('is_first_time_jobseeker') ? 'required' : '' }}>
