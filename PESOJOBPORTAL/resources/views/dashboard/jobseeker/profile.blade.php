...
@php
    ...
    $skillGroups = [
        ...
        'it_technical' => [
            ...
            'options' => [
                'Computer Literate', 'Microsoft Office', 'Web Development', 'System Developer', 'Programming', 'Database', 'JavaScript', 'HTML/CSS', 'Git',
                'Database Management', 'Frontend Development (Web UI)', 'API Integration & Development', 'Software Development & Debugging',
                'Network Configuration & Troubleshooting', 'Hardware Installation & Repair', 'Graphic Design', 'React.js', 'Node.js', 'REST API',
                'Backend Development (Server-side)', 'Virtual Assistance', 'Data Entry and Record Keeping', 'Filing and Documentation',
                'Scheduling and Calendar Management', 'MySQL (Database)', 'Flutter', 'Docker', 'Laravel (Backend)'
            ],
        ],
        'soft_skills' => [
            'label'   => 'Soft Skills',
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6 col-xl-3">
                        ...
                        <input class="form-control profile-input" name="personal_information[suffix]" placeholder="Sr., Jr., II"
                            value="{{ old('personal_information.suffix', $personalInformation['suffix'] ?? '') }}">
                    </div>
                        ...
                        <div class="profile-radio-stack">
                            ...
                            <label class="profile-radio-item">
                                <input type="radio" name="personal_information[sex]" value="Female"
                                    @checked(old('personal_information.sex', $personalInformation['sex'] ?? '') === 'Female')> Female
                            </label>
                        </div>
                    </div>
                    <div class="col-12 col-md-6 col-xl-3">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <label class="profile-check-label mb-0">
                        <input type="checkbox" name="education_currently_in_school" value="1"
                            @checked(old('education_currently_in_school', $personalInformation['currently_in_school'] ?? false))>
                        Currently in school?
                    </label>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-12 col-lg-4">
                                    <input class="form-control profile-input" data-field="course"
                                        name="education[{{ $index }}][course]" placeholder="Course / Strand"
                                        value="{{ $row['course'] ?? '' }}">
                                </div>
                                <div class="col-12 col-lg-2">
                                    <input class="form-control profile-input" data-field="year"
                                        name="education[{{ $index }}][year]" placeholder="Year"
                                        value="{{ $row['year'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-lg-6">
                                    ...
                                    <input class="form-control profile-input" data-field="certificates"
                                        name="training[{{ $index }}][certificates]" value="{{ $row['certificates'] ?? '' }}">
                                </div>
                            </div>
                        </div>
                    @endforeach
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input class="form-control profile-input" data-field="company"
                                        ...
                                        value="{{ $row['company'] ?? '' }}" placeholder="PixelCraft Web Services">
                                </div>
                                <div class="col-12 col-lg-4">
                                    ...
                                    <input class="form-control profile-input" data-field="title"
                                        ...
                                        value="{{ $row['title'] ?? '' }}" placeholder="Freelance Web Developer">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control profile-input" rows="4" data-field="details"
                                        name="experience[{{ $index }}][details]">{{ $row['details'] ?? '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    @endforeach
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6 col-lg-2">
                                    ...
                                    <input class="form-control profile-input" data-field="date_taken"
                                        name="eligibility[{{ $index }}][date_taken]"
                        ...
                        <div class="profile-skill-grid">
                            @foreach ($group['options'] as $option)
                                <label class="profile-check-tile">
                                    <input type="checkbox" name="other_skills[{{ $key }}][]"
                                        value="{{ $option }}"
                                        @checked(in_array($option, (array) $selectedSkills, true))>
                                    <span>{{ $option }}</span>
                                </label>
                            @endforeach
                        </div>
                            ...
                            <div class="profile-inline-choice">
                                ...
                                <label class="profile-radio-inline">
                                    <input type="radio" name="other_skills[with_certificate]" value="1"
                                        @checked((string) $withCertificate === '1')> Yes
                                </label>
                                <label class="profile-radio-inline">
                                    <input type="radio" name="other_skills[with_certificate]" value="0"
                                        @checked((string) $withCertificate === '0')> No
                                </label>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="profile-inline-choice">
                                ...
                                <label class="profile-radio-inline">
                                    <input type="radio" name="other_skills[by_experience]" value="1"
                                        @checked((string) $byExperience === '1')> Yes
                                </label>
                                <label class="profile-radio-inline">
                                    <input type="radio" name="other_skills[by_experience]" value="0"
                                        @checked((string) $byExperience === '0')> No
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        @foreach ($employmentTypes as $key => $label)
                            @if ($key !== 'unemployed')
                                <label class="profile-check-tile profile-check-tile--stacked">
                                    <input type="checkbox" name="employment_status[{{ $key }}]" value="1"
                                        @checked((bool) data_get($employmentStatus, $key, false))>
                                    <span>{{ $label }}</span>
                                </label>
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <label class="profile-check-tile profile-check-tile--stacked">
                            <input type="checkbox" name="employment_status[unemployed]" value="1"
                                @checked((bool) data_get($employmentStatus, 'unemployed', false))>
                        ...
                        <div class="profile-language-row">
                            <div class="profile-language-name">
                                <input type="text" class="form-control profile-input profile-language-other mb-2"
                                    ...
                                    value="{{ $row['language'] ?? '' }}" placeholder="Language/Dialect">
                                @if (($row['language'] ?? '') === 'Others:')
                                    <input type="text" class="form-control profile-input"
                                        name="languages[{{ $index }}][other]"
                                        value="{{ $row['other'] ?? '' }}" placeholder="Specify">
                                @endif
                            </div>
                            <label class="profile-language-check">
                                <input type="checkbox" name="languages[{{ $index }}][read]" value="1"
                                    @checked((bool) ($row['read'] ?? false))>
                            </label>
                            <label class="profile-language-check">
                                <input type="checkbox" name="languages[{{ $index }}][write]" value="1"
                                    @checked((bool) ($row['write'] ?? false))>
                            </label>
                            <label class="profile-language-check">
                                <input type="checkbox" name="languages[{{ $index }}][speak]" value="1"
                                    @checked((bool) ($row['speak'] ?? false))>
                            </label>
                            <label class="profile-language-check">
                                <input type="checkbox" name="languages[{{ $index }}][understand]" value="1"
                                    @checked((bool) ($row['understand'] ?? false))>
                            </label>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="profile-disability-grid">
                    <label class="profile-check-tile profile-check-tile--stacked">
                        <input type="checkbox" name="disability[visual]" value="1"
                            @checked((bool) data_get($disability, 'visual', false))>
                        <span>Visual</span>
                    </label>
                    <label class="profile-check-tile profile-check-tile--stacked">
                        <input type="checkbox" name="disability[speech]" value="1"
                            @checked((bool) data_get($disability, 'speech', false))>
                        <span>Speech</span>
                    </label>
                    <label class="profile-check-tile profile-check-tile--stacked">
                        <input type="checkbox" name="disability[mental]" value="1"
                            @checked((bool) data_get($disability, 'mental', false))>
                        <span>Mental</span>
                    </label>
                    <label class="profile-check-tile profile-check-tile--stacked">
                        <input type="checkbox" name="disability[hearing]" value="1"
                            @checked((bool) data_get($disability, 'hearing', false))>
                        <span>Hearing</span>
                    </label>
                    <label class="profile-check-tile profile-check-tile--stacked">
                        <input type="checkbox" name="disability[physical]" value="1"
                            @checked((bool) data_get($disability, 'physical', false))>
                        <span>Physical</span>
                    </label>
                    <label class="profile-check-tile profile-check-tile--stacked">
                        <input type="checkbox" name="disability[other]" value="1"
                            @checked((bool) data_get($disability, 'other', false))>
                        <span>Others (please specify)</span>
                    </label>
                    <div class="col-12">
                        <input class="form-control profile-input" name="disability[other_text]"
                            value="{{ data_get($disability, 'other_text', '') }}" placeholder="Specify">
                    </div>
                </div>
            </div>
