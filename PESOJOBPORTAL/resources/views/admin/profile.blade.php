        ...
        <div class="profile-card">
            ...
            <div style="display: grid; gap: 1rem;">
                ...
                <div style="display: grid; grid-template-columns: 200px 1fr; gap: 1rem; align-items: center;">
                    ...
                    <span style="color: #0d1f3c; font-weight: 600;">{{ $admin->created_at->format('F d, Y') }}</span>
                </div>
                <div style="display: grid; grid-template-columns: 200px 1fr; gap: 1rem; align-items: center;">
                    <span style="color: #6b7280; font-weight: 600;">Last Updated:</span>
                    <span style="color: #0d1f3c; font-weight: 600;">{{ $admin->updated_at->format('F d, Y \a\t g:i A') }}</span>
                </div>
                <div style="display: grid; grid-template-columns: 200px 1fr; gap: 1rem; align-items: center;">
                    <span style="color: #6b7280; font-weight: 600;">Account ID:</span>
                    <span style="color: #a1a5ab; font-family: monospace; font-weight: 500;">#{{ $admin->id }}</span>
                </div>
            </div>
        </div>
    </div>
