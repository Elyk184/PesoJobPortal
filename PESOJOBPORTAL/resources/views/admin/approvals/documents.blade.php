...
<div class="admin-wrapper">
    ...
    <aside class="admin-sidebar" id="adminSidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sidebar-menu-item">
                <a href="{{ route('admin.document-verification') }}" class="sidebar-menu-link active">
        ...
        <div class="admin-topbar">
            <div class="admin-topbar-left">
                <div class="topbar-title">
                    <h2><i class="bi bi-file-earmark me-2"></i>Document Verification</h2>
                    <div class="topbar-subtitle">Review and verify employer-submitted documents</div>
                </div>
            </div>
