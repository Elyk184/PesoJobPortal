        ...
        <table>
            ...
            <tbody>
                @forelse($employers as $employer)
                    <tr>
                        <td class="company-name">{{ $employer->companyProfile?->company_name ?? $employer->name }}</td>
                        <td class="contact-person">{{ $employer->companyProfile?->establishment_contact_person ?? 'N/A' }}</td>
                        <td class="employer-email">{{ $employer->email }}</td>
                        <td class="joined-date">{{ $employer->created_at?->format('d M Y') ?? 'N/A' }}</td>
