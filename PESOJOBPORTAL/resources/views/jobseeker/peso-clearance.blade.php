...
<section aria-label="PESO Clearance">
	...
	<div class="row g-3 mb-4">
		<div class="col-12 col-md-4">
			<div class="dashboard-stat-card clearance-metric p-3 d-flex align-items-center gap-3">
			...
			<div class="dashboard-stat-card clearance-metric p-3 d-flex align-items-center gap-3">
				...
				<div>
					<div class="dashboard-stat-number">
						{{ $hasPendingRequest ? 'Pending' : ($isActive ? 'Active' : 'Inactive') }}
					</div>
		...
		@else
			<div class="row g-3">
				<div class="col-12 col-lg-7">
					<div class="dashboard-empty-state clearance-empty">
						<div>
				...
				<div class="col-12 col-lg-5">
					<div class="card border-0 shadow-sm h-100 clearance-request-card">
						<div class="card-body p-4">
							<h3 class="h5 fw-bold mb-2">Request PESO Clearance</h3>
							<p class="text-muted small mb-3">Send a clearance request to the admin for processing.</p>

							<form method="POST" action="{{ route('jobseeker.peso-clearance.request') }}">
								@csrf
								<div class="mb-3">
								...
								<div class="d-grid">
									<button type="submit" class="btn btn-primary clearance-cta" {{ $canRequestClearance ? '' : 'disabled' }}>
