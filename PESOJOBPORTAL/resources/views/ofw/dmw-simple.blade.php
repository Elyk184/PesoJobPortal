            ...
            <form method="POST" action="{{ route('ofw.dmw-download') }}" enctype="multipart/form-data">
                ...
                <div class="dmw-section">
                    ...
                    <div class="dmw-grid" style="margin-top:14px;">
                        <div class="dmw-field">
                            ...
                            <input type="date" name="ofw_birthdate" value="{{ old('ofw_birthdate') }}">
                        </div>
                        <div class="dmw-field">
                            <label>Contact No.</label>
                            <input type="text" name="ofw_contact" value="{{ old('ofw_contact') }}">
                        </div>
                    </div>
                    ...
                    <div class="dmw-grid" style="margin-top:14px;">
                        <div class="dmw-field">
                            ...
                            <input type="text" name="ofw_address_ph" value="{{ old('ofw_address_ph') }}">
                        </div>
                        <div class="dmw-field">
                            <label>Address Abroad</label>
                            <input type="text" name="ofw_address_abroad" value="{{ old('ofw_address_abroad') }}">
                        </div>
                    </div>
                </div>
                ...
                <div class="dmw-section">
                    ...
                    <div class="dmw-field">
                        ...
                        <textarea name="facts_of_case" placeholder="Isalaysay ang inyong request...">{{ old('facts_of_case') }}</textarea>
                    </div>
                </div>
                ...
                <div class="dmw-actions">
                    <a href="{{ route('ofw.dashboard') }}" class="btn btn-outline-secondary px-4">Back to Dashboard</a>
