...
<aside class="dashboard-sidebar">
    ...
    <nav class="dashboard-nav" aria-label="Dashboard navigation">
        ...
        @elseif ($role === 'association')
            <div class="dashboard-nav-section">
                <div class="dashboard-nav-label">Overview</div>
                <a href="{{ route('association.dashboard') }}" class="dashboard-nav-link {{ request()->routeIs('association.dashboard') ? 'is-active' : '' }}">
                    <i class="bi bi-speedometer2"></i>
                    <span>Dashboard</span>
                </a>
            </div>
            ...
            <div class="dashboard-nav-section">
                ...
                <a href="{{ route('association.accepted-requests') }}" class="dashboard-nav-link {{ request()->routeIs('association.accepted-requests') ? 'is-active' : '' }}">
            ...
            <div class="dashboard-nav-section">
                <div class="dashboard-nav-label">Account</div>
                <a href="{{ route('association.profile') }}" class="dashboard-nav-link {{ request()->routeIs('association.profile') ? 'is-active' : '' }}">
                    <i class="bi bi-person-circle"></i>
                    <span>My Profile</span>
                </a>
            </div>
