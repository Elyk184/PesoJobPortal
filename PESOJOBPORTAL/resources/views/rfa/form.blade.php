...
<style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .rfa-field input[type="text"]:focus,
    .rfa-field input[type="date"]:focus { border-bottom-color: #1e40af; background: #f0f7ff; }

    .rfa-field textarea {
        border: 1px solid #555;
        padding: 5px 6px; resize: vertical; font-size: 11.5px;
    }
    .rfa-field textarea:focus { border-color: #1e40af; background: #f0f7ff; }
    ...
    .rfa-field input[type="file"]:hover { border-color: #475569; background: #f1f5f9; }
    ...
    .rfa-btn-submit:hover { background: #374151; }
    .rfa-btn-submit:disabled { background: #6b7280; cursor: not-allowed; }
    ...
    @media (max-width: 640px) {
        ...
        .rfa-g2.top-row { grid-template-columns: 1fr; }
    }

    @keyframes rfa-spin { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }
</style>
@endpush
...
<div class="rfa-wrapper">
    ...
    <form class="rfa-sheet"
        ...
        <div class="rfa-header">
            <div class="rfa-logo">
                <img src="{{ asset('images/owwa-logo.png') }}" alt="OWWA">
            </div>
        ...
        <div class="rfa-g2">
            <div class="rfa-field">
                ...
                <input type="text" id="e_cares_ticket_number" name="e_cares_ticket_number"
                             value="{{ old('e_cares_ticket_number') }}">
            </div>
            <div class="rfa-field">
        ...
        <div class="rfa-cb-grid">
            @foreach ($caseOptions as $key => $label)
                <label>
                    <input type="checkbox" name="nature_of_case[]" value="{{ $key }}"
                        {{ in_array($key, old('nature_of_case', []), true) ? 'checked' : '' }}>
                    {{ $label }}
                </label>
            @endforeach
        </div>
        ...
        <div class="rfa-others-row">
            <input type="checkbox" name="nature_of_case[]" value="others" id="others_check"
                {{ in_array('others', old('nature_of_case', []), true) ? 'checked' : '' }}>
            <label for="others_check">Others:</label>
            <input type="text" name="nature_of_case_other"
                         placeholder="Please specify..."
                         value="{{ old('nature_of_case_other') }}">
        </div>
        ...
        <div class="rfa-g5 mt8">
            ...
            <div class="rfa-field">
                ...
                <input type="text" name="birthdate" placeholder="MM/DD/YYYY" value="{{ old('birthdate') }}">
            </div>
            <div class="rfa-field">
                <label>Age:</label>
        ...
        <div class="rfa-g3 mt8">
            <div class="rfa-field">
                ...
                <input type="text" name="facebook_name" value="{{ old('facebook_name') }}">
            </div>
            <div class="rfa-field">
        ...
        <div class="rfa-g2 mt8">
            <div class="rfa-field">
                ...
                <input type="text" name="children_count" value="{{ old('children_count') }}">
            </div>
            <div class="rfa-field">
        ...
        <div class="rfa-g2 mt8">
            <div class="rfa-field">
                <label>Tel. No. / Fax No.:</label>
                <input type="text" name="tel_fax" value="{{ old('tel_fax') }}">
            </div>
            <div class="rfa-field">
                <label>Monthly Salary:</label>
                <input type="text" name="monthly_salary" value="{{ old('monthly_salary') }}">
            </div>
        </div>
        ...
        <div class="rfa-g2 mt8">
            <div class="rfa-field">
                <label>Address and Tel. No.:</label>
                <input type="text" name="agency_address_tel" value="{{ old('agency_address_tel') }}">
            </div>
            <div class="rfa-field">
                <label>Name of Local Agency:</label>
                <input type="text" name="local_agency" value="{{ old('local_agency') }}">
            </div>
        </div>

        <div class="rfa-g2 mt8">
            <div class="rfa-field">
                <label>Date of Latest Departure From the Philippines:</label>
                <input type="text" name="latest_departure" placeholder="MM/DD/YYYY" value="{{ old('latest_departure') }}">
            </div>
            <div class="rfa-field">
                <label>OFW's Previous Employment (Please Specify Country):</label>
                <input type="text" name="previous_employment_country" value="{{ old('previous_employment_country') }}">
            </div>
        </div>

        <div class="rfa-g3 mt8">
            <div class="rfa-field">
                <label>For Death Case: Date of Death:</label>
                <input type="text" name="death_date" placeholder="MM/DD/YYYY" value="{{ old('death_date') }}">
            </div>
            <div class="rfa-field">
                <label>Cause of Death:</label>
                <input type="text" name="death_cause" value="{{ old('death_cause') }}">
            </div>
            <div class="rfa-field">
                <label>Place of Death:</label>
                <input type="text" name="death_place" value="{{ old('death_place') }}">
            </div>
        </div>
        ...
        <div class="rfa-g2 mt8">
            <div class="rfa-field">
                ...
                <input type="text" name="complete_address" value="{{ old('complete_address') }}">
            </div>
            <div class="rfa-field">
                <label>Phone No. / Email Address:</label>
                <input type="text" name="phone_email" value="{{ old('phone_email') }}">
            </div>
        </div>
