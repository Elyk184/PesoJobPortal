...
class JobseekerController extends Controller
{
    ...
    public function saveProfile(Request $request): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'personal_information.civil_status' => ['required', 'string', 'max:50'],
            'personal_information.height' => ['required', 'numeric', 'min:0', 'max:999.99'],
            'personal_information.tin' => ['nullable', 'string', 'max:20'],
            'personal_information.contact_number' => ['required', 'string', 'max:50'],
            'personal_information.email_address' => ['required', 'email', 'max:255'],
            'education_currently_in_school' => ['nullable', 'boolean'],

            'present_address.house_no' => ['required', 'string', 'max:255'],
            'present_address.barangay' => ['required', 'string', 'max:100'],
            'present_address.municipality' => ['required', 'string', 'max:100'],
            'present_address.province' => ['required', 'string', 'max:100'],

            'permanent_address.same_as_present' => ['nullable', 'boolean'],
            'permanent_address.house_no' => ['required_unless:permanent_address.same_as_present,1', 'string', 'max:255'],
            'permanent_address.barangay' => ['required_unless:permanent_address.same_as_present,1', 'string', 'max:100'],
            'permanent_address.municipality' => ['required_unless:permanent_address.same_as_present,1', 'string', 'max:100'],
            'permanent_address.province' => ['required_unless:permanent_address.same_as_present,1', 'string', 'max:100'],
            ...
            'employment_status.wage_employed' => ['required_without_all:employment_status.self_employed,employment_status.unemployed', 'boolean'],
            'employment_status.wage_employed_specify' => ['nullable', 'string', 'max:255'],
            'employment_status.self_employed' => ['required_without_all:employment_status.wage_employed,employment_status.unemployed', 'boolean'],
            'employment_status.self_employed_specify' => ['nullable', 'string', 'max:255'],
            'employment_status.unemployed' => ['required_without_all:employment_status.wage_employed,employment_status.self_employed', 'boolean'],
