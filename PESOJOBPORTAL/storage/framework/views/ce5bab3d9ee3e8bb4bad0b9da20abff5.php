...
<div class="manage-jobs-wrap">
    <div class="manage-jobs-card">
        ...
        <div class="jobs-tabbar">
            <a class="jobs-tab <?php echo e($selectedTab === 'active' ? 'active' : ''); ?>" href="<?php echo e(route('employer.jobs.manage', ['status' => 'active'])); ?>">
                <i class="bi bi-briefcase"></i> Active Jobs
                <span class="jobs-tab-badge"><?php echo e($tabCounts['active'] ?? 0); ?></span>
            </a>
            <a class="jobs-tab <?php echo e($selectedTab === 'pending' ? 'active' : ''); ?>" href="<?php echo e(route('employer.jobs.manage', ['status' => 'pending'])); ?>">
                <i class="bi bi-hourglass-split"></i> Pending Approval
                <span class="jobs-tab-badge gray"><?php echo e($tabCounts['pending'] ?? 0); ?></span>
            </a>
            <a class="jobs-tab <?php echo e($selectedTab === 'draft' ? 'active' : ''); ?>" href="<?php echo e(route('employer.jobs.manage', ['status' => 'draft'])); ?>">
                <i class="bi bi-file-earmark"></i> Drafts
                <span class="jobs-tab-badge gray"><?php echo e($tabCounts['draft'] ?? 0); ?></span>
            </a>
            <a class="jobs-tab <?php echo e($selectedTab === 'archived' ? 'active' : ''); ?>" href="<?php echo e(route('employer.jobs.manage', ['status' => 'archived'])); ?>">
                <i class="bi bi-archive"></i> Archived
                <span class="jobs-tab-badge yellow"><?php echo e($tabCounts['archived'] ?? 0); ?></span>
            </a>
            <a class="jobs-tab <?php echo e($selectedTab === 'filled' ? 'active' : ''); ?>" href="<?php echo e(route('employer.jobs.manage', ['status' => 'filled'])); ?>">
        ...
        <div class="jobs-table-head">
            ...
            <span class="jobs-table-meta"><i class="bi bi-collection"></i><?php echo e($jobs->count()); ?> items</span>
        </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="job-sub"><i class="bi bi-briefcase"></i><?php echo e($formatEmployment($job->job_type)); ?></div>
                            </td>
                            <td class="cell-company"><span class="value-with-icon"><i class="bi bi-building"></i><?php echo e($job->employer_name ?: (auth()->user()->profile?->company_name ?? auth()->user()->name)); ?></span></td>
                            <td class="cell-location"><span class="value-with-icon"><i class="bi bi-geo-alt"></i><?php echo e($job->location ?: 'No location'); ?></span></td>
                            <td><span class="employment-pill"><?php echo e($formatEmployment($job->job_type)); ?></span></td>
                            <td><span class="value-with-icon"><i class="bi bi-currency-dollar"></i><?php echo e($formatSalary($job)); ?></span></td>
                            <td class="cell-num"><?php echo e($job->vacancies ?? 0); ?></td>
                            <td class="cell-num"><span class="apps-pill"><?php echo e($job->applications_count ?? 0); ?></span></td>
                            <td class="cell-num"><?php echo e($job->views ?? $job->view_count ?? 0); ?></td>
                            <td class="cell-date"><span class="value-with-icon"><i class="bi bi-calendar3"></i><?php echo e(optional($job->application_end_date)->format('M d, Y') ?: 'No deadline'); ?></span></td>
                            <td class="cell-status">
                                <span class="status-chip <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span>
                            </td>
                            <td class="text-end cell-actions">
                                <div class="action-row">
                                    <a href="<?php echo e(route('employer.applicants.index')); ?>" class="icon-btn view" title="View Applicants" aria-label="View Applicants">
                                    ...
                                    <form action="<?php echo e(route('employer.jobs.duplicate', $job)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                    ...
                                    <?php if(($job->status ?? null) !== 'closed'): ?>
                                        <form action="<?php echo e(route('employer.jobs.filled', $job)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <?php if(($job->status ?? null) !== 'closed'): ?>
                                        <form action="<?php echo e(route('employer.jobs.archive', $job)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
