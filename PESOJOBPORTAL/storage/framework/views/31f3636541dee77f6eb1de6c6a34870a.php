        ...
        <div class="row g-3">
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <div class="dashboard-stat-card p-3 h-100 position-relative">
                    <a href="<?php echo e(route('jobseeker.applications', ['status' => 'interview'])); ?>" class="stretched-link" aria-label="View interview applications"></a>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\63965\PesoJobPortal\PESOJOBPORTAL\resources\views/dashboard/jobseeker/dashboard.blade.php ENDPATH**/ ?>