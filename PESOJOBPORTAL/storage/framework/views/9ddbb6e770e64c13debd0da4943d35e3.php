    ...
    <div class="dashboard-section-card p-3 p-lg-4">
        <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3 mb-3 border-bottom pb-3">
            ...
            <div class="d-flex flex-wrap gap-2 status-filter-wrap">
                ...
                <a href="<?php echo e(route('jobseeker.applications', ['status' => 'shortlisted'])); ?>" class="btn btn-sm status-filter-btn <?php echo e($statusFilter === 'shortlisted' ? 'btn-success' : 'btn-outline-success'); ?>">Shortlisted (<?php echo e($statusCounts['shortlisted'] ?? 0); ?>)</a>
                <a href="<?php echo e(route('jobseeker.applications', ['status' => 'interview'])); ?>" class="btn btn-sm status-filter-btn <?php echo e($statusFilter === 'interview' ? 'btn-primary' : 'btn-outline-primary'); ?>">Interview (<?php echo e($statusCounts['interview'] ?? 0); ?>)</a>
