<?php $__env->startSection('title', 'Submit Documents'); ?>
    ...
    <div class="docs-page">
        ...
        <div class="docs-grid">
            <section class="docs-card">
                ...
                <form class="docs-form" id="mainForm" method="POST" action="<?php echo e(route('employer.recruitment.request')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="docs-helper-grid">
                        <div class="docs-field">
                            ...
                            <select id="activity_type" name="activity_type" required>
                                ...
                                <option value="lra" <?php if(old('activity_type', $defaultActivityType) === 'lra'): echo 'selected'; endif; ?>>LRA</option>
                                <option value="sra" <?php if(old('activity_type', $defaultActivityType) === 'sra'): echo 'selected'; endif; ?>>SRA</option>
                            </select>
                        </div>
                    </div>
...
<?php echo $__env->make('dashboard.employer.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views/dashboard/employer/submit-documents.blade.php ENDPATH**/ ?>