    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="composer-hero mb-4">
                ...
                <div class="hero-meta">
                    <span class="hero-pill"><i class="bi bi-hash"></i> Job #<?php echo e($job->id); ?></span>
                    <span class="hero-pill"><i class="bi bi-briefcase"></i> <?php echo e(ucfirst($job->status ?? 'draft')); ?></span>
                </div>
            </div>
