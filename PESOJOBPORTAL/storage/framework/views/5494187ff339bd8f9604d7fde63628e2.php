<?php $__env->startSection('title', 'Terms of Service | PESO Job Portal'); ?>
...
<section class="tos-page">
    <div class="container tos-shell">
        ...
        <div class="tos-content">
            ...
            <div class="tos-links">
                <a href="<?php echo e(route('privacy-policy')); ?>">View Privacy Policy</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views\terms-of-service.blade.php ENDPATH**/ ?>