            ...
            <div class="page-wrapper">
                <form method="POST" action="<?php echo e(route('association.registration.submit')); ?>" enctype="multipart/form-data" class="form-page">
                    ...
                    <div class="attestation-section">
                        ...
                        <input type="checkbox" name="declaration" id="declaration" value="1" <?php echo e(old('declaration') ? 'checked' : ''); ?> style="display:none;" required>
                        ...
                        <input type="text" name="president_signature" value="<?php echo e(old('president_signature')); ?>" class="notary-input-long" placeholder="President signature over printed name" style="margin-top:10px;">
