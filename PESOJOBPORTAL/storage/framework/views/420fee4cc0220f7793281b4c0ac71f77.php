    ...
    <div class="col-lg-4">
        ...
        <div class="info-card">
            ...
            <form id="statusForm" action="<?php echo e(route('employer.applications.update', $application->id)); ?>" method="POST">
                ...
                <div class="mb-4" id="interviewDateField" style="display: <?php echo e($application->status == 'interview' ? 'block' : 'none'); ?>;">
                    <label class="form-label">Interview Date & Time</label>
                    <input type="datetime-local" name="interview_scheduled_at" id="interviewScheduledAt" class="form-control" value="<?php echo e($application->interview_scheduled_at ? $application->interview_scheduled_at->format('Y-m-d\\TH:i') : ''); ?>">
                </div>
                <div class="mb-4">
