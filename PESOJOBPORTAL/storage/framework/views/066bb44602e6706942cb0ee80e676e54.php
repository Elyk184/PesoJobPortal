<?php $__env->startSection('title', 'Association | Dashboard'); ?>
    ...
    <section aria-label="Association dashboard">
        <div class="dashboard-topbar">
            ...
            <div class="d-none d-md-block text-end">
                <div class="fw-semibold text-secondary"><?php echo e($associationUser->name ?? 'Association'); ?></div>
        ...
        <div class="dashboard-section-card p-3 p-lg-4 mb-4">
            <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                <div>
                    <h2 class="h4 mb-1 fw-bold">Welcome back, <?php echo e($associationUser->name ?? 'Association'); ?>!</h2>
                ...
                <div class="dashboard-highlight" style="min-width: 280px; background: #f7f9fc; color: #314458; border: 1px solid var(--dash-border); box-shadow: none;">
                    ...
                    <div class="dashboard-highlight-value" style="color: #23374f;"><?php echo e($profileSummary['name'] ?? $associationUser->name ?? 'Association'); ?></div>
                    <div class="dashboard-highlight-note" style="color: var(--dash-muted);">
                        <?php echo e($profileSummary['email'] ?? $associationUser->email); ?>

                        <?php if(! empty($profileSummary['phone'])): ?>
                            <br><?php echo e($profileSummary['phone']); ?>

                        <?php endif; ?>
                        <?php if(! empty($profileSummary['address'])): ?>
                            <br><?php echo e($profileSummary['address']); ?>
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="<?php echo e(route('association.registration-form')); ?>" class="btn btn-danger px-3 shadow-sm">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-md-4">
                <div class="dashboard-stat-card p-3 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="dashboard-stat-number"><?php echo e($requestStats['open'] ?? 0); ?></div>
            ...
            <div class="col-12 col-md-4">
                <div class="dashboard-stat-card p-3 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="dashboard-stat-number"><?php echo e($requestStats['under_review'] ?? 0); ?></div>
            ...
            <div class="col-12 col-md-4">
                <div class="dashboard-stat-card p-3 d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="dashboard-stat-number"><?php echo e($requestStats['resolved'] ?? 0); ?></div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-lg-4">
                <div class="dashboard-section-card h-100 p-3 p-lg-4">
                    ...
                    <a href="<?php echo e(route('association.registration-form')); ?>" class="btn btn-danger w-100">
            ...
            <div class="col-12 col-lg-4">
                <div class="dashboard-section-card h-100 p-3 p-lg-4">
                    <div class="d-flex align-items-center justify-content-between gap-3 mb-3 border-bottom pb-3">
                        ...
                        <span class="badge rounded-pill text-bg-light text-secondary"><?php echo e(($submittedRequests ?? collect())->count()); ?> recent</span>
                    </div>
                    <p class="text-muted mb-3">
                        Review your latest submitted requests and current processing status.
                    </p>
                    <a href="<?php echo e(route('association.submitted-requests')); ?>" class="btn btn-outline-primary w-100">
            ...
            <div class="dashboard-section-card p-3 p-lg-4">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $submittedRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($request->subject); ?></td>
                                    <td><?php echo e($request->association_name ?? 'N/A'); ?></td>
                                    <td>
                                        <?php if($request->status === 'open'): ?>
                                            <span class="badge bg-primary">Open</span>
                                        <?php elseif($request->status === 'under_review'): ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views/dashboard/association/dashboard.blade.php ENDPATH**/ ?>