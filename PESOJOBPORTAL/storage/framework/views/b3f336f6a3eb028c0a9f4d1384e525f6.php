                ...
                <form action="<?php echo e(route('jobseeker.browse-jobs')); ?>" method="GET" id="filterForm">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?php echo e(route('jobseeker.browse-jobs')); ?>" class="btn btn-sm btn-outline-secondary">
                                ...
                                <article class="job-card p-3 mb-3 d-flex flex-column flex-md-row align-items-start gap-3">
                                    ...
                                    <div class="job-card-actions ms-auto text-end d-flex flex-column gap-2">
                                        ...
                                        <?php if(auth()->guard()->check()): ?>
                                            ...
                                            <button
                                                type="button"
                                                class="btn btn-sm <?php echo e($isSaved ? 'btn-warning' : 'btn-outline-secondary'); ?> js-save-job-btn"
                                            ...
                                            >
                                                <i class="bi <?php echo e($isSaved ? 'bi-bookmark-dash' : 'bi-bookmark'); ?> js-save-job-icon"></i>
                                            </button>
                                        <?php endif; ?>
                                        <small class="text-muted d-block d-md-none">Posted <?php echo e($job->created_at->diffForHumans()); ?></small>
                                    </div>
                                </article>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\63965\PesoJobPortal\PESOJOBPORTAL\resources\views/jobseeker/browse-jobs.blade.php ENDPATH**/ ?>