...
<div class="mb-3">
        ...
        <p class="text-center mb-0 login-foot">
            Don't have an account? <a href="<?php echo e(route('register')); ?>" class="link-muted">Register</a>
        </p>
    </main>
...
<?php /**PATH C:\Users\63965\PesoJobPortal\PESOJOBPORTAL\resources\views/login.blade.php ENDPATH**/ ?>