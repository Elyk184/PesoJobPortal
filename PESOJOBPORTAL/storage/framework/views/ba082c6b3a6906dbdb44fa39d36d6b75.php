<?php $__env->startSection('title', 'Brief Historical Background | Link Job Resource Portal'); ?>

<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/history-section.css') . '?v=' . filemtime(public_path('css/history-section.css'))); ?>">
<?php $__env->stopPush(); ?>
    ...
    <div class="history-container">
        <div class="history-card">
            <div class="history-image-col">
                ...
                <img src="<?php echo e(asset('images/historybg.png')); ?>" alt="Manolo Fortich History">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views/history.blade.php ENDPATH**/ ?>