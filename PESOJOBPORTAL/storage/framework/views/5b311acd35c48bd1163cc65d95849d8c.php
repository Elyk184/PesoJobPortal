<?php $__env->startSection('title', 'Association | My Profile'); ?>
...
<section aria-label="Association Profile">
    ...
    <form method="POST" action="<?php echo e(route('association.profile.update')); ?>">
        <?php echo csrf_field(); ?>
            ...
            <div class="dashboard-section-card p-3 p-lg-4">
                ...
                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        ...
                        <input class="form-control <?php $__errorArgs = ['association_name'];
...
unset($__errorArgs, $__bag); ?>"
                               ...
                               value="<?php echo e(old('association_name', $associationProfile->association_name)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               name="contact_person"
                               value="<?php echo e(old('contact_person', $associationProfile->contact_person)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               name="phone"
                               value="<?php echo e(old('phone', $associationProfile->phone)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               name="email"
                               value="<?php echo e(old('email', $associationProfile->email)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               name="address"
                               value="<?php echo e(old('address', $associationProfile->address)); ?>">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views/dashboard/association/profile.blade.php ENDPATH**/ ?>