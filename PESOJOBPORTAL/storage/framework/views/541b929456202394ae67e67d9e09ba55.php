...
<div class="page">
  <div class="header">
    ...
    <div class="logo right"><?php if($bagong_logo): ?><img src="<?php echo e($bagong_logo); ?>" alt="Bagong Pilipinas"><?php endif; ?></div>
  </div>
  <hr class="divider">
  <div class="title">REQUEST FOR ASSISTANCE (RFA) FORM</div>
  <div class="mode">[<?php echo e(in_array('online', $mode ?? []) ? 'X' : ' '); ?>] Online &nbsp;&nbsp;&nbsp; [<?php echo e(in_array('walkin', $mode ?? []) ? 'X' : ' '); ?>] Walk-in &nbsp;&nbsp;&nbsp; [<?php echo e(in_array('referral', $mode ?? []) ? 'X' : ' '); ?>] Referral by: ____________________ <?php echo e($referral_by ?? ''); ?></div>
  <div class="sec">A. &nbsp; IMPORMASYON NG OFW:</div>
  <table class="form">
    <tr><td class="label">Pangalan ng OFW :</td><td><div class="name"><div><?php echo e($ofw_lastname ?? ''); ?><div class="small">Last name</div></div><div><?php echo e($ofw_firstname ?? ''); ?><div class="small">First Name</div></div><div><?php echo e($ofw_middlename ?? ''); ?><div class="small">Middle Name</div></div></div></td></tr>
    <tr><td class="label">Birthdate:</td><td><?php echo e($ofw_birthdate ?? ''); ?></td></tr>
    <tr><td class="label">Sex (Kasarian):</td><td class="check">[<?php echo e(($ofw_sex ?? '') === 'male' ? 'X' : ' '); ?>] Male/Lalaki &nbsp;&nbsp;&nbsp; [<?php echo e(($ofw_sex ?? '') === 'female' ? 'X' : ' '); ?>] Female/Babae</td></tr>
    <tr><td class="label">Civil Status:</td><td class="check">[<?php echo e(in_array('single', $civil_status ?? []) ? 'X' : ' '); ?>] Single / Walang Asawa &nbsp; [<?php echo e(in_array('married', $civil_status ?? []) ? 'X' : ' '); ?>] Married / May Asawa &nbsp; [<?php echo e(in_array('widow', $civil_status ?? []) ? 'X' : ' '); ?>] Widow/Widower (Balo)<br>[<?php echo e(in_array('separated', $civil_status ?? []) ? 'X' : ' '); ?>] Separated / Hiwalay &nbsp; [<?php echo e(in_array('soloparent', $civil_status ?? []) ? 'X' : ' '); ?>] Solo Parent</td></tr>
    <tr><td class="label">Passport / Travel Document No:</td><td><?php echo e($ofw_passport ?? ''); ?></td></tr>
    <tr><td class="label">Address sa abroad:</td><td><?php echo e($ofw_address_abroad ?? ''); ?></td></tr>
    <tr><td class="label">Address sa Pilipinas</td><td><?php echo e($ofw_address_ph ?? ''); ?></td></tr>
    <tr><td class="label">Contact No/s. Mobile/Phone No.:</td><td><?php echo e($ofw_contact ?? ''); ?></td></tr>
    <tr><td class="label">Email / Facebook Account:</td><td><?php echo e($ofw_email ?? ''); ?></td></tr>
  </table>
  <div class="sec" style="margin-top:12px;">B. &nbsp; IMPORMASYON NG KAMAG-ANAK NG OFW NA HUMIHINGI NG TULONG:</div>
  <table class="form">
    <tr><td class="label">Pangalan :</td><td><div class="name"><div><?php echo e($fam_lastname ?? ''); ?><div class="small">Last name</div></div><div><?php echo e($fam_firstname ?? ''); ?><div class="small">First Name</div></div><div><?php echo e($fam_middlename ?? ''); ?><div class="small">Middle Name</div></div></div></td></tr>
    <tr><td class="label">Birthdate:</td><td><?php echo e($fam_birthdate ?? ''); ?></td></tr>
    <tr><td class="label">Relationship to OFW:</td><td class="check">[<?php echo e(in_array('spouse', $relationship ?? []) ? 'X' : ' '); ?>] Spouse / Asawa &nbsp; [<?php echo e(in_array('child', $relationship ?? []) ? 'X' : ' '); ?>] Child / Anak &nbsp; [<?php echo e(in_array('sibling', $relationship ?? []) ? 'X' : ' '); ?>] Sibling / Kapatid &nbsp; [<?php echo e(in_array('others', $relationship ?? []) ? 'X' : ' '); ?>] Others <?php echo e($relationship_others ?? ''); ?></td></tr>
    <tr><td class="label">ID No:</td><td><?php echo e($fam_id ?? ''); ?></td></tr>
    <tr><td class="label">Address sa Pilipinas</td><td><?php echo e($fam_address ?? ''); ?></td></tr>
    <tr><td class="label">Mobile/Phone No.:</td><td><?php echo e($fam_contact ?? ''); ?></td></tr>
    <tr><td class="label">Email / Facebook Account:</td><td><?php echo e($fam_email ?? ''); ?></td></tr>
  </table>
  <div class="page-number">15</div>
</div>
<div class="page">
  <div class="sec">C. &nbsp; URI NG TULONG NA HINIHINGI (Please check):</div>
  <div class="box assist">[<?php echo e(in_array('legal', $assistance ?? []) ? 'X' : ' '); ?>] LEGAL ASSISTANCE &nbsp;&nbsp; [<?php echo e(in_array('medical', $assistance ?? []) ? 'X' : ' '); ?>] MEDICAL ASSISTANCE &nbsp;&nbsp; [<?php echo e(in_array('repatriation', $assistance ?? []) ? 'X' : ' '); ?>] REPATRIATION<br>[<?php echo e(in_array('rescue', $assistance ?? []) ? 'X' : ' '); ?>] RESCUE / EVACUATION &nbsp;&nbsp; [<?php echo e(in_array('welfare', $assistance ?? []) ? 'X' : ' '); ?>] WELFARE ASSISTANCE FOR SENIOR OFW RETURNEES<br>[<?php echo e(in_array('compassionate', $assistance ?? []) ? 'X' : ' '); ?>] COMPASSIONATE VISIT &nbsp;&nbsp; [<?php echo e(in_array('shipment', $assistance ?? []) ? 'X' : ' '); ?>] SHIPMENT OF HUMAN REMAINS / CREMAINS<br>[<?php echo e(in_array('food', $assistance ?? []) ? 'X' : ' '); ?>] FOOD ASSISTANCE &nbsp;&nbsp; [<?php echo e(in_array('transportation', $assistance ?? []) ? 'X' : ' '); ?>] TRANSPORTATION ASSISTANCE &nbsp;&nbsp; [<?php echo e(in_array('shelter', $assistance ?? []) ? 'X' : ' '); ?>] TEMPORARY SHELTER<br>[<?php echo e(in_array('others', $assistance ?? []) ? 'X' : ' '); ?>] OTHERS: <?php echo e($assistance_others ?? ''); ?></div>
  <div class="sec">D. &nbsp; MAIKLING SALAYSAY TUNGKOL SA HINIHINGING TULONG:</div>
  <div class="box narrative"><?php echo e($narrative ?? ''); ?></div>
  <div class="sec">E. &nbsp; ACCOUNT KUNG SAAN IDEDEPOSITO ANG PINANSYAL NA TULONG:</div>
  <table class="account"><tr><td class="auth">In the event of the approval of my application for financial assistance, I hereby authorize the Department of Migrant Workers to credit the assistance through the account/s I have indicated on the right portion:</td><td class="sig">SIGNATURE OF<br>APPLICANT:<div class="sig-space"></div></td><td class="bank">[<?php echo e(!empty($has_bank) ? 'X' : ' '); ?>] Bank Account No: <?php echo e($bank_account_no ?? ''); ?><br><br>Bank: <?php echo e($bank_name ?? ''); ?> &nbsp; Branch: <?php echo e($bank_branch ?? ''); ?><br><br>Account Name: <?php echo e($bank_account_name ?? ''); ?></td></tr></table>
...
<div class="page"><div class="attachment"><div class="attachment-title">Page 3 - Employment Contract</div><div class="attachment-subtitle">Uploaded image attachment</div><div class="uploaded"><?php if($contract_image): ?><img src="<?php echo e($contract_image); ?>" alt="Employment Contract"><?php endif; ?></div></div><div class="page-number">17</div></div>
<div class="page"><div class="attachment"><div class="attachment-title">Page 4 - Passport / Travel Document</div><div class="attachment-subtitle">Uploaded image attachment</div><div class="uploaded"><?php if($passport_image): ?><img src="<?php echo e($passport_image); ?>" alt="Passport"><?php endif; ?></div></div><div class="page-number">18</div></div>
</body>
</html>
