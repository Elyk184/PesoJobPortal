                    ...
                    <tbody>
                        <?php $__currentLoopData = $submissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $submission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge <?php echo e($submission->status === 'accepted' ? 'text-bg-success' : ($submission->status === 'rejected' ? 'text-bg-danger' : 'text-bg-warning text-dark')); ?>">
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <?php if($submission->status !== 'accepted' && $submission->status !== 'rejected'): ?>
                                        ...
                                        <?php if($submission->status !== 'rejected' && $submission->status !== 'accepted'): ?>
                                            <form method="POST" action="<?php echo e(route('admin.ofw-submissions.reject', $submission)); ?>"
                                        ...
                                        <?php if($submission->status === 'accepted' || $submission->status === 'rejected'): ?>
                                            <form method="POST" action="<?php echo e(route('admin.ofw-submissions.undo', $submission)); ?>"
