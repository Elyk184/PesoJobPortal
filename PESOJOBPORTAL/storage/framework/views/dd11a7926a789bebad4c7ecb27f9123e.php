...
<head>
    ...
    <?php if(file_exists(public_path('images/PESO.png'))): ?>
        <link rel="icon" href="<?php echo e(asset('images/PESO.png')); ?>" type="image/png">
        <link rel="apple-touch-icon" href="<?php echo e(asset('images/PESO.png')); ?>">
    <?php else: ?>
    ...
    <style>
        ...
        .team-section { padding: 4rem 0; background: linear-gradient(rgba(255, 255, 255, 0.85), rgba(255, 255, 255, 0.85)), url('<?php echo e(asset("images/LogoPNG.png")); ?>'); background-size: 600px; background-position: center; background-repeat: no-repeat; }
...
<?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views/structure.blade.php ENDPATH**/ ?>