<?php $__env->startSection('title', 'History of Excellence | Link Job Resource Portal'); ?>

<?php $__env->startPush('styles'); ?>
<link rel="stylesheet" href="<?php echo e(asset('css/history-timeline.css') . '?v=' . filemtime(public_path('css/history-timeline.css'))); ?>">
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views\history-excellence.blade.php ENDPATH**/ ?>