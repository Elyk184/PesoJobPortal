<?php $__env->startSection('title', 'Privacy Policy | PESO Job Portal'); ?>
...
<section class="pp-page">
    <div class="container pp-shell">
        ...
        <article class="pp-card">
            ...
            <div class="pp-links">
                <a href="<?php echo e(route('terms-of-service')); ?>">View Terms of Service</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views\privacy-policy.blade.php ENDPATH**/ ?>