...
<div class="admin-dashboard">
    ...
    <div class="alerts-shell">
            ...
            <div class="alerts-stat">
                ...
                <div id="adminUnreadStat" class="alerts-stat-value"><?php echo e($adminUnreadNotificationsCount ?? 0); ?></div>
        ...
        <div class="alerts-panel">
            <div class="alerts-panel-head">
                ...
                <span id="adminUnreadBadge" class="badge text-bg-primary rounded-pill px-3 py-2"><?php echo e($adminUnreadNotificationsCount ?? 0); ?> unread</span>
            </div>
            ...
            <div class="alerts-list">
                <?php $__empty_1 = true; $__currentLoopData = ($adminNotifications ?? collect()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <div class="alert-item" data-notification-id="<?php echo e($notification->id); ?>">
