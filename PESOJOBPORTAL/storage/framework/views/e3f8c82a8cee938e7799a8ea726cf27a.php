            ...
            <div class="application-form-card">
                ...
                <form action="<?php echo e(route('jobseeker.submit-application', $job)); ?>" method="POST" enctype="multipart/form-data" id="applicationForm">
                    ...
                    <?php if($hasResumeBuilderData): ?>
                        <button type="button" class="resume-btn w-100 <?php echo e($defaultResumeType === 'builder' ? 'active' : ''); ?>" style="margin-bottom: 1rem; grid-column: 1/-1;" data-resume-type="builder" onclick="switchResumeType(this)">
                            <i class="bi bi-file-earmark-text"></i> Use Resume Builder
                        </button>
                    <?php else: ?>
                        <a href="<?php echo e(route('jobseeker.resume-builder')); ?>" class="resume-btn w-100" style="margin-bottom: 1rem; grid-column: 1/-1; text-decoration:none; display:block;">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\63965\PesoJobPortal\PESOJOBPORTAL\resources\views/jobseeker/apply-job.blade.php ENDPATH**/ ?>