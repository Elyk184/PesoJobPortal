<aside class="admin-sidebar" id="adminSidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="sidebar-menu-item">
            <a href="<?php echo e(route('admin.jobseekers.index')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.jobseekers*') ? 'active' : ''); ?>">
        ...
        <li class="sidebar-menu-item">
            <a href="<?php echo e(route('admin.lra-sra-approvals')); ?>" class="sidebar-menu-link <?php echo e(request()->routeIs('admin.lra-sra-approvals') ? 'active' : ''); ?>">
                ...
                <?php if(($adminSidebarCounts['pendingLraSraApprovals'] ?? 0) > 0): ?>
                    <span class="sidebar-badge" style="background:#ec4899;"><?php echo e($adminSidebarCounts['pendingLraSraApprovals']); ?></span>
                <?php endif; ?>
            </a>
        </li>
        <li class="sidebar-menu-item">
...
<?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views/components/admin/sidebar.blade.php ENDPATH**/ ?>