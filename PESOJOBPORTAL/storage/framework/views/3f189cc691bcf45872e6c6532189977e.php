...
<div class="footer-quote-secondary">SOAR HIGH MANOLO FORTICH</div>
        ...
        <!-- Jobseeker Name -->
        <div class="jobseeker-name"><?php echo e(strtoupper($name)); ?></div>
        ...
        <div class="content-text">
            ...
            <br><br>
            THIS CERTIFIES FURTHER THAT based on the clearances issued by the BARANGAY <?php echo e(strtoupper($residence_address ?? '(LGU AREA)')); ?> herein subject person has NO DEROGATORY RECORD.
            <br><br>
            This EMPLOYMENT CLEARANCE is issued in connection with <?php echo e($possessive_pronoun ?? 'their'); ?> desire to work at:
        </div>

        <!-- Company Section -->
        <div class="company-section">
            <div class="company-name"><?php echo e(strtoupper($company_name ?? 'GENERAL SERVICES MULTIPURPOSE COOPERATIVE')); ?></div>
        ...
        <div class="clearance-details">
            <div class="detail-row">
                ...
                <span><?php echo e($clearance_number); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">DATE ISSUED:</span>
                <span><?php echo e($issue_date); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">VALID UNTIL:</span>
                <span><?php echo e($expiry_date); ?></span>
            </div>
        </div>

</body>
</html>
<?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views\documents\peso-clearance-certificate.blade.php ENDPATH**/ ?>