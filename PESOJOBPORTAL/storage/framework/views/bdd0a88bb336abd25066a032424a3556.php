...
<?php $__env->startSection('title', 'OFW | Dashboard'); ?>
    ...
    <section aria-label="OFW dashboard">
        <div class="dashboard-topbar">
            ...
            <div class="d-none d-md-block text-end">
                <div class="fw-semibold text-secondary"><?php echo e($ofwUser->name ?? 'OFW'); ?></div>
        ...
        <div class="dashboard-section-card p-3 p-lg-4 mb-4">
            <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                <div>
                    <h2 class="h4 mb-1 fw-bold">Welcome back, <?php echo e($ofwUser->name ?? 'OFW'); ?>!</h2>
                ...
                <div class="dashboard-highlight" style="min-width: 280px; background: #f7f9fc; color: #314458; border: 1px solid var(--dash-border); box-shadow: none;">
                    ...
                    <div class="dashboard-highlight-value" style="color: #23374f;"><?php echo e($profileSummary['name'] ?? $ofwUser->name ?? 'OFW'); ?></div>
                    <div class="dashboard-highlight-note" style="color: var(--dash-muted);">
                        <?php echo e($profileSummary['email'] ?? $ofwUser->email); ?>
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="<?php echo e(route('ofw.owwa-request')); ?>" class="btn btn-danger px-3 shadow-sm">
                        <i class="bi bi-file-earmark-plus me-2"></i>Start OWWA RFA
                    </a>
                    <?php if(optional(auth()->user())->role === 'ofw'): ?>
                        <a href="<?php echo e(route('ofw.dmw-builder')); ?>" class="btn btn-outline-primary px-3">
        ...
        <div class="row g-3 mb-4">
            <div class="col-12 col-lg-4">
                <div class="dashboard-section-card h-100 p-3 p-lg-4">
                    ...
                    <a href="<?php echo e(route('ofw.accepted-requests')); ?>" class="btn btn-outline-primary w-100">
            ...
            <div class="col-12 col-lg-4">
                <div class="dashboard-section-card h-100 p-3 p-lg-4">
                    ...
                    <a href="<?php echo e(route('ofw.owwa-request')); ?>" class="btn btn-danger w-100">
                        <i class="bi bi-arrow-right me-2"></i>Open Page
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="dashboard-section-card h-100 p-3 p-lg-4">
                    ...
                    <a href="<?php echo e(route('ofw.dmw-builder')); ?>" class="btn btn-outline-primary w-100">
            ...
            <div class="col-12 col-lg-4">
                <div class="dashboard-section-card h-100 p-3 p-lg-4">
                    ...
                    <a href="<?php echo e(route('ofw.submitted-requests')); ?>" class="btn btn-outline-primary w-100">
                        <i class="bi bi-arrow-right me-2"></i>Open Page
                    </a>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views/ofw/dashboard.blade.php ENDPATH**/ ?>