<?php $__env->startSection('title', 'Jobseekers | PESO Admin'); ?>
...
<div class="admin-dashboard">
    ...
    <div class="approval-header">
        <div class="approval-stat">
            ...
            <div class="approval-stat-value"><?php echo e($jobseekers->total()); ?></div>
            <i class="bi bi-people approval-stat-icon"></i>
        </div>
        <div class="approval-stat">
            <div class="approval-stat-label">Available Jobs</div>
            <div class="approval-stat-value"><?php echo e($availableJobs->count()); ?></div>
    ...
    <div class="dashboard-card">
        ...
        <?php if($jobseekers->count() > 0): ?>
                                ...
                                <td>
                                    <div class="jobseeker-name">
                                        <div class="jobseeker-avatar">
                                            <?php echo e(strtoupper(substr($jobseeker->name ?? 'U', 0, 1))); ?>

                                        </div>
                                        <strong><?php echo e(Str::limit($jobseeker->name ?? 'N/A', 25)); ?></strong>
                                    </div>
                                </td>
                                <td><?php echo e(Str::limit($jobseeker->email ?? 'N/A', 30)); ?></td>
                                <td>
                                    <span class="badge-count"><?php echo e($jobseeker->applications_count ?? 0); ?> apps</span>
                                </td>
                                <td><small><?php echo e($jobseeker->created_at->format('d M, Y')); ?></small></td>
                                <td>
                                    <div class="action-buttons">
                                        <a href="<?php echo e(route('admin.jobseekers.show', $jobseeker)); ?>" class="btn btn-sm btn-view">
                                            <i class="bi bi-eye"></i> View Profile
                                        </a>
                                        <button type="button" class="btn btn-sm btn-recommend open-recommend-modal" 
                                                data-jobseeker-id="<?php echo e($jobseeker->id); ?>" 
                                                data-jobseeker-name="<?php echo e($jobseeker->name ?? 'N/A'); ?>" 
                                                title="Recommend Job">
            ...
            <nav aria-label="Page navigation" class="mt-4">
                <?php echo e($jobseekers->links('pagination::bootstrap-5')); ?>
    ...
    <script>
        const jobsByEmployer = {
            <?php $__currentLoopData = $availableJobs->groupBy('employer_id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employerId => $jobs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($employerId); ?>: [
                    <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        {
                            id: <?php echo e($job->id); ?>,
                            title: '<?php echo e(addslashes($job->title)); ?>',
                            employerName: '<?php echo e(addslashes($job->employer?->name ?? 'Unknown')); ?>',
                            companyName: '<?php echo e(addslashes($job->employer?->companyProfile?->company_name ?? $job->employer?->name ?? 'Unknown Company')); ?>',
                            location: '<?php echo e(addslashes($job->location ?? 'N/A')); ?>',
                            salary: '<?php echo e(addslashes($job->salary_range ?? 'Not specified')); ?>',
                            description: '<?php echo e(addslashes($job->description ?? 'No description provided')); ?>',
                            jobType: '<?php echo e(addslashes($job->job_type ?? 'N/A')); ?>',
                            vacancies: <?php echo e($job->vacancies ?? 0); ?>,
                            qualifications: '<?php echo e(addslashes($job->qualifications ?? '')); ?>',
                            keyResponsibilities: '<?php echo e(addslashes($job->key_responsibilities ?? '')); ?>',
                            preferredSkills: '<?php echo e(addslashes($job->preferred_skills ?? '')); ?>',
                            experience: '<?php echo e(addslashes($job->experience ?? '')); ?>',
                            education: '<?php echo e(addslashes($job->education ?? '')); ?>',
                            benefits: '<?php echo e(addslashes($job->benefits ?? '')); ?>',
                            requirements: '<?php echo e(addslashes($job->requirements ?? '')); ?>',
                            applicationStartDate: '<?php echo e($job->application_start_date?->format('Y-m-d') ?? ''); ?>',
                            applicationEndDate: '<?php echo e($job->application_end_date?->format('Y-m-d') ?? ''); ?>'
                        },
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ],
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            openModalButtons.forEach(button => {
                button.addEventListener('click', function(e) {
                    ...
                    recommendForm.action = <?php echo json_encode(route('admin.jobseekers.recommend-job', ['jobseeker' => '__JOBSEEKER_ID__']), 512) ?>.replace('__JOBSEEKER_ID__', jobseekerId);
...
<?php echo $__env->make('layouts.admin-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views\admin\jobseekers\approvals.blade.php ENDPATH**/ ?>