<?php $__env->startSection('title', 'Applications Analytics | PESO Admin'); ?>
...
<div class="admin-dashboard">
    ...
    <div class="filter-section">
        ...
        <form id="analyticsFilterForm" method="GET" action="<?php echo e(route('admin.applications-analytics')); ?>" style="display: flex; gap: 1rem; flex-wrap: wrap; align-items: center;">
            <div class="filter-group">
                ...
                <select id="periodSelect" name="period" style="padding: 0.6rem 1rem; border: 1.5px solid #e5e7eb; border-radius: 8px; font-size: 14px; font-weight: 500; color: #0f172a; background: white; cursor: pointer; transition: all 0.2s ease;">
                    <option value="7days" <?php echo e(request('period', '7days') === '7days' ? 'selected' : ''); ?>>Last 7 Days</option>
                    <option value="30days" <?php echo e(request('period') === '30days' ? 'selected' : ''); ?>>Last 30 Days</option>
            ...
            <div class="filter-group" id="customDateRange" style="display: <?php echo e(request('period') === 'custom' ? 'flex' : 'none'); ?>; gap: 1rem;">
                <div>
                    <label for="startDate" style="font-size: 12px; font-weight: 600; color: #64748b; margin-bottom: 0.5rem; display: block;">From Date</label>
                    <input type="date" id="startDate" name="start_date" value="<?php echo e(request('start_date')); ?>" style="padding: 0.6rem 1rem; border: 1.5px solid #e5e7eb; border-radius: 8px; font-size: 14px; color: #0f172a; background: white;">
                </div>
                <div>
                    <label for="endDate" style="font-size: 12px; font-weight: 600; color: #64748b; margin-bottom: 0.5rem; display: block;">To Date</label>
                    <input type="date" id="endDate" name="end_date" value="<?php echo e(request('end_date')); ?>" style="padding: 0.6rem 1rem; border: 1.5px solid #e5e7eb; border-radius: 8px; font-size: 14px; color: #0f172a; background: white;">
                </div>
            </div>
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card pending">
            <div class="stat-value"><?php echo e($pendingApplications); ?></div>
            <div class="stat-label">Pending</div>
        </div>
        <div class="stat-card accepted">
            <div class="stat-value"><?php echo e($acceptedApplications); ?></div>
            <div class="stat-label">Accepted</div>
        </div>
        <div class="stat-card rejected">
            <div class="stat-value"><?php echo e($rejectedApplications); ?></div>
            ...
            <?php if($totalApplications > 0): ?>
                ...
                <div class="chart-legend">
                    <div class="legend-item">
                        ...
                        <span>Pending: <?php echo e($pendingApplications); ?> (<?php echo e(round($pendingApplications/$totalApplications*100, 1)); ?>%)</span>
                    </div>
                    <div class="legend-item">
                        <div class="legend-color" style="background-color: #10b981;"></div>
                        <span>Accepted: <?php echo e($acceptedApplications); ?> (<?php echo e(round($acceptedApplications/$totalApplications*100, 1)); ?>%)</span>
                    </div>
                    <div class="legend-item">
                        <div class="legend-color" style="background-color: #ef4444;"></div>
                        <span>Rejected: <?php echo e($rejectedApplications); ?> (<?php echo e(round($rejectedApplications/$totalApplications*100, 1)); ?>%)</span>
                    </div>
                </div>
            <?php else: ?>
                <div class="no-data">
            ...
            <?php if($totalApplications > 0): ?>
                ...
                <div class="chart-legend">
                    <div class="legend-item">
                        ...
                        <span>Female: <?php echo e($femaleCount); ?> (<?php echo e(round($femaleCount/$totalApplications*100, 1)); ?>%)</span>
                    </div>
                    <div class="legend-item">
                        <div class="legend-color" style="background-color: #0ea5e9;"></div>
                        <span>Male: <?php echo e($maleCount); ?> (<?php echo e(round($maleCount/$totalApplications*100, 1)); ?>%)</span>
                    </div>
                    <div class="legend-item">
                        <div class="legend-color" style="background-color: #14b8a6;"></div>
                        <span>Other: <?php echo e($otherCount); ?> (<?php echo e(round($otherCount/$totalApplications*100, 1)); ?>%)</span>
                    </div>
                </div>
            <?php else: ?>
                <div class="no-data">
        ...
        <table class="stats-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td><strong><?php echo e($pendingApplications); ?></strong></td>
                    <td><?php echo e($totalApplications > 0 ? round($pendingApplications/$totalApplications*100, 1) : 0); ?>%</td>
                    <td>
                        <div class="percentage-bar">
                            <div class="percentage-fill" style="width: <?php echo e($totalApplications > 0 ? ($pendingApplications/$totalApplications*100) : 0); ?>%; background: #f59e0b;">
                                <?php echo e($totalApplications > 0 ? round($pendingApplications/$totalApplications*100, 1) : 0); ?>%
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><strong><?php echo e($acceptedApplications); ?></strong></td>
                    <td><?php echo e($totalApplications > 0 ? round($acceptedApplications/$totalApplications*100, 1) : 0); ?>%</td>
                    <td>
                        <div class="percentage-bar">
                            <div class="percentage-fill" style="width: <?php echo e($totalApplications > 0 ? ($acceptedApplications/$totalApplications*100) : 0); ?>%; background: #10b981;">
                                <?php echo e($totalApplications > 0 ? round($acceptedApplications/$totalApplications*100, 1) : 0); ?>%
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><strong><?php echo e($rejectedApplications); ?></strong></td>
                    <td><?php echo e($totalApplications > 0 ? round($rejectedApplications/$totalApplications*100, 1) : 0); ?>%</td>
                    <td>
                        <div class="percentage-bar">
                            <div class="percentage-fill" style="width: <?php echo e($totalApplications > 0 ? ($rejectedApplications/$totalApplications*100) : 0); ?>%; background: #ef4444;">
                                <?php echo e($totalApplications > 0 ? round($rejectedApplications/$totalApplications*100, 1) : 0); ?>%
                            </div>
                        </div>
                    </td>
                </tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const totalApps = <?php echo e($totalApplications); ?>;
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [
                                ...
                                <?php echo e($acceptedApplications); ?>,
                                <?php echo e($rejectedApplications); ?>
                ...
                new Chart(trendCtx, {
                    ...
                    data: {
                        ...
                        datasets: [
                            ...
                            {
                                label: 'Accepted',
                                data: <?php echo json_encode($trendAccepted); ?>,
                                borderColor: '#10b981',
                            ...
                            {
                                label: 'Rejected',
                                data: <?php echo json_encode($trendRejected); ?>,
                                borderColor: '#ef4444',
...
<?php echo $__env->make('layouts.admin-dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views\admin\applications-analytics.blade.php ENDPATH**/ ?>