<?php $__env->startSection('title', 'Vacancies | Jobseeker | PESO Job Portal'); ?>
...
<section class="container py-4" aria-label="Job vacancies">
    <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-lg-between gap-3 mb-3">
        ...
        <a href="<?php echo e(route('jobseeker.dashboard')); ?>" class="btn btn-outline-danger">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PesoJobPortal\PESOJOBPORTAL\resources\views\dashboard\jobseeker\vacancies.blade.php ENDPATH**/ ?>